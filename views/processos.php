...
<div class="container">
    <h1 class="mb-4">Lista de Processos</h1>
    <div class="alert alert-info">Aqui será exibida a lista de processos cadastrados.</div>
    <!-- Tabela de processos será implementada aqui -->
</div>
